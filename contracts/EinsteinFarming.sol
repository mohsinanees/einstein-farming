    ...
    ReentrancyGuardUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        if (_amount == userInfo[msg.sender][lpToken].farmedAmount) {
            ...
            emit WithdrawFromFarmedBalance(msg.sender, _amount);
        }
        ...
        for (uint256 i = 0; i < userFarmCount[_rewardAddress][lpToken]; i++) {
            if (
                ...
                if (balances > 0) {
                    ...
                    //         timeDifferences = poolInfo[lpToken].endTime.sub(
                    //             farmingTimestamps[_rewardAddress][lpToken][i]
                    //         );
                    //     } else {
                    //         timeDifferences =
    ...
    */
    ...
    /*
    @dev function used to refarm the reward for the caller of the method
    */
